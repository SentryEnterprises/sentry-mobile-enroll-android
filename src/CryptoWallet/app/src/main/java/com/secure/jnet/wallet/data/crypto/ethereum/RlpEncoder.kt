...
//
//import com.secure.jnet.wallet.util.ext.stripHexPrefix
//import com.secure.jnet.wallet.util.ext.toByteArray
//import com.secure.jnet.wallet.util.ext.toByteArrayWithoutLeadingZero
...
//        return encode(input.toByteArray())
//    }
//
...
//    }
//
//    fun encode(input: BigInteger): ByteArray {
//        return encode(input.toByteArrayWithoutLeadingZero())
//    }
//
...
//        return encode(address.stripHexPrefix().toByteArray())
//    }
//
